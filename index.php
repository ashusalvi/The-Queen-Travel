    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="margin-top: 88px;">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="images/slider/slider_1.png" alt="First slide">
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="images/slider/slider_2.png" alt="Second slide">
                <!-- <div class="carousel-caption d-none d-md-block">
                    <h5>Leisure Trips</h5>
                    <p>Aria is a top consultancy company specializing in business growth using online marketing and
                        conversion optimization tactics</p>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="images/slider/slider_3.png" alt="Third slide">
                <!-- <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="images/slider/slider_4.png" alt="Third slide">
                <!-- <div class="carousel-caption d-none d-md-block">
                    <h5>Honeymoon and sightseeings</h5>
                    <p>Aria is a top consultancy company specializing in business growth using online marketing and
                        conversion optimization tactics</p>
